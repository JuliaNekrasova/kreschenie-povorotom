<div class="titlepage">
  <div class="kicker">Шпаргалка по приказу</div>
...
**Материал:** «Сахарный диабет у детей». Версия 1.1. Шпаргалка по действующим документам Станции; дублируется карточкой в приложении «Маршрут вызова». В версии 1.1 добавлены три схемы и раздел «Источники иллюстраций».
