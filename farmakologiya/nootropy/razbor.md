...
Самое сильное на сегодня исследование — **MIR** (NCT06437626): 304 пациента, многоцентровое, двойное слепое, плацебо-контролируемое, острый ишемический инсульт.

| Показатель | Мексидол | Плацебо | p | Примечание |
|---|---|---|---|---|
| Изменение mRS (медиана от исходного) | улучшение значимо больше | — | 0,003 | первичная точка |
| NIHSS | значимое улучшение | — | <0,001 | вторичная точка |
| Rivermead Mobility Index | лучшая подвижность | — | 0,014 | вторичная точка |
| MoCA | тенденция к уменьшению когнитивного дефицита | — | — | не значимо |
...
Цитофлавин — попытка «подстелить энергетическую соломку» под страдающие клетки. Логика: при ишемии митохондрии перестают синтезировать АТФ, развивается гипоксия, и клетки погибают. Если дать субстраты и коферменты цикла Кребса, можно обойти это повреждение.

Состав:
- **Янтарная кислота** — субстрат сукцинатдегидрогеназы, точка входа в дыхательную цепь.
- **Инозин (рибоксин)** — предшественник пуриновых нуклеотидов, субстрат для синтеза АТФ.
- **Рибофлавин (B2)** — кофермент ФАД, необходимый для сукцинатдегидрогеназы.
- **Никотинамид (PP)** — предшественник НАД, кофермент цикла Кребса.

Концепция «субстратной энергетической композиции» принадлежит фармакологическому направлению, развитому в Петербурге под руководством **И.А. Строкова** и сотрудников НТФФ «ПОЛИСАН». Идея: не один молекулярный актив, а комбинация метаболитов и коферментов, работающих в одной биохимической цепи.

Проблема: это элегантно для культуры клеток, но для инсульта мозг не страдает от дефицита янтарной кислоты — он страдает от недостатка кислорода. Без O₂ дыхательная цепь останавливается, и сколько ни подкладывай субстратов, последнее звено не сработает.
...
Кроме дозы есть ещё одна проблема: **гематоэнцефалический барьер**. Глицин маленький и незаряженный, поэтому частично проходит пассивно, но основной путь — через транспортеры нейтральных аминокислот (системы A, ASC). При этом он конкурирует с другими малыми аминокислотами из еды. Бо́льшая часть проглоченного глицина остаётся в периферии и быстро разрушается ферментом глициноксидазой до воды и CO₂.
...
| Препарат | Кокрейновский обзор | Лучшее РКИ | FDA | EMA | AHA/ASA |
|---|---|---|---|---|---|
| **Пирацетам** | 3 обзора: деменция — нет эффекта; инсульт — нет эффекта, тренд к ↑ смертности; афазия — слабые данные | PASS (n=927): нет пользы, RR смерти 1,24 | Не одобрен | Нац. регистрации (миоклонус) | Не упоминается |
| **Церебролизин** | 2 обзора: инсульт — нет пользы, ↑ НЯ; деменция — очень низкая достоверность | CASTA (n≈1 070): провал первичной точки | Не одобрен | Нац. рег. в Австрии | Не упоминается |
| **Мексидол** | Нет | MIR (n=304), спонсор-производитель | Не одобрен | Не одобрен | Не упоминается |
| **Семакс** | Нет | 110 пациентов, нерандомизированное | Не одобрен | Не одобрен | Не упоминается |
| **Цитофлавин** | Нет | MITRA (n=166, ЧМТ); CYLINDER (n=216, нейропатия) | Не одобрен | Не одобрен | Не упоминается |
| **Актовегин** | Нет | ARTEMIDA (n=503): −2,3 балла ADAScog+, спонсор Takeda | Не одобрен | Нац. рег. в Австрии; снят в Швейцарии | Не упоминается |
| **Глицин** | Нет | Нет РКИ по российским дозам (100 мг) | Пищевая добавка (E640) | Пищевая добавка | Не упоминается |
| **Фенибут** | Нет | **Нет РКИ** | Не одобрен | Не одобрен | Не упоминается |
...
Это воспроизводимый результат: молекулы, эффективные в пробирке, не работают в человеке. Пенумбра слишком гетерогенна, окно слишком узко, барьер слишком непроницаем, а мозг — не клеточная культура.
...
> **Ни один ноотроп или нейропротектор не улучшает исход инсульта, деменции или когнитивных нарушений на уровне доказательности, достаточном для международного стандарта лечения.**
