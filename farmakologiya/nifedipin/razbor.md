...
<img src="images/moloecula.png" alt="Структурная формула нифедипина">
...
|---|---|---|
| `moloecula.png` | Структурная формула нифедипина | Wikimedia Commons; структурные формулы химических соединений не являются объектом авторского права |
