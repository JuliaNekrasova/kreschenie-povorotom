...
**О фотографии.** Снимок бумажной плёнки сделан автором. В тексте нет имени, возраста, адреса, номера карты вызова и названия стационара; на самой плёнке видны дата, время и служебные данные аппарата без сведений о пациенте.

**Об измерениях.** Значения, которые вывел аппарат, приведены как есть. Величины, отмеченные словом «около» (ширина комплексов, амплитуды, интервалы между артефактами), измерены по фотографии плёнки с калибровкой по сетке.

**Оговорка.** Материал учебный. Он не является нормативным документом, не заменяет действующие протоколы, клинические рекомендации и распоряжения службы и не может использоваться как единственное основание для клинического решения. Дозы, показания и маршрутизацию проверять по первоисточникам, действующим на момент чтения.
