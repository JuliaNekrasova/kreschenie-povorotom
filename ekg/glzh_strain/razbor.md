...
<figcaption>Рис. 1. Учебный пример. Двенадцать отведений, 25 мм/с, 10 мм/мВ, ритм-лента II снизу. Зубцы S в V3 настолько глубоки, что уходят за край канала и наезжают на ритм-ленту. Подъём ST в V1–V3 пропорционален этим зубцам S — ожидаемая дискордантность. Strain — во всех отведениях с положительным зубцом R: V5–V6, I, II, III, aVF. Воспроизведено из Dr Smith’s ECG Blog (через LITFL ECG Library). Не плёнка разбираемого вызова.</figcaption>
</figure>
...
**Реполяризация.** Во всех отведениях с положительным зубцом R (V5–V6, I, II, III, aVF) — косонисходящая депрессия сегмента ST с асимметричной инверсией зубца T (пологое снижение, крутой возврат к изолинии). В правых грудных с глубоким зубцом S (V1–V3) — дискордантный подъём ST. Подъём пропорционален глубине S: ожидаемая дискордантность, а не ток повреждения. Все смещения ST направлены противоположно основному зубцу QRS.
...
Индекс **Корнелла** (S в V3 + R в aVL, пороги разные для мужчин и женщин) и **произведение Корнелла** (индекс, умноженный на длительность QRS) меньше зависят от грудной геометрии и у пожилых в среднем надёжнее.
...
|---|---|---|
| `ekg_glzh_strain.png` | Двенадцать отведений, 25 мм/с, 10 мм/мВ: ГЛЖ, S в V3 за краем канала, ожидаемая дискордантность, strain | воспроизведено из Dr Smith’s ECG Blog через LITFL ECG Library, «Left Ventricular Hypertrophy», Example 2; учебный пример, не плёнка разбираемого вызова |
