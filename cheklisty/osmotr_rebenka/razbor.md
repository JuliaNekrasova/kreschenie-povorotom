...
## 1. PAT — от двери, до контакта, около 15 секунд

**Внешний вид:** тонус, реакция на окружающих, слежение взглядом, характер крика или речи, удаётся ли утешить. **Работа дыхания:** втяжения яремной ямки, межреберий, подреберий; раздувание крыльев носа; вынужденное положение; стридор; кряхтение. **Кожа:** цвет, мраморность, цианоз, бледность, сыпь.

Итог — одна категория: стабилен / компенсирован / декомпенсирован. Отсутствие зрительного контакта при нормальных витальных показателях — неблагоприятный признак.

## 2. ABCDE

**A** — содержимое полости рта, слюнотечение, положение, признаки инородного тела. **B** — ЧД подсчётом за 30–60 с, аускультация в шести точках, симметрия экскурсии, SpO₂. **C** — ЧСС, центральный и периферический пульс, капиллярное наполнение (норма < 2 с), АД, температура кистей и стоп. **D** — сознание, зрачки, **глюкоза у каждого ребёнка**, менингеальные знаки, очаговая симптоматика, судороги. **E** — кожа целиком, температура, сыпь, следы травмы, гигиена.

## 3. Возрастные нормы в покое, в бодрствовании

| Возраст | ЧСС | ЧД | Нижняя граница САД |
|---|---|---|---|
| Новорождённый | 110–160 | 30–50 | > 60 |
| 1–12 мес | 100–150 | 25–40 | > 70 |
| 1–2 года | 90–140 | 22–35 | > 70 + 2 × возраст |
| 3–5 лет | 80–130 | 20–30 | > 70 + 2 × возраст |
| 6–11 лет | 70–110 | 18–25 | > 70 + 2 × возраст |
| 12 лет и старше | 60–100 | 12–20 | > 90 |

SpO₂ ≥ 95 %. Гипогликемия: у ребёнка < 3,0 ммоль/л, у новорождённого < 2,6 ммоль/л.

**Тахикардия — самый ранний признак декомпенсации. Гипотензия появляется последней и означает срыв компенсации.** Повторный подсчёт через 10 минут в спокойной обстановке: стрессовая тахикардия уменьшается, патологическая сохраняется. Дифференциал: боль, страх, лихорадка, дегидратация, анемия, гипоксия, гиповолемия, нейролептики и β-агонисты, тиреотоксикоз, аритмия, интоксикация.

## 4. Дегидратация — пять признаков

Слизистые языка и внутренней поверхности губы · капиллярное наполнение > 2 с · тургор на животе или бедре · западение орбит и наличие слёз при плаче · время и объём последнего мочеиспускания. Дополнительно: родничок у младенца, масса тела до заболевания. Внешний вид сам по себе недостаточен.

## 5. Осмотр от головы к пяткам — порядок фиксированный

Голова (родничок, гематомы, зрачки, симметрия лица) · глаза, уши, нос · ротоглотка (**при подозрении на эпиглоттит насильственный осмотр не выполняется**) · лимфатические узлы · шея и менингеальные знаки · грудная клетка · живот (лёжа, тёплыми руками, с безболезненного участка) · **наружные половые органы и перианальная область — входят в стандарт**, перекрут яичка выявляется только при осмотре мошонки · кожа целиком (петехии, не бледнеющие при диаскопии, — менингококцемия) · конечности и позвоночник · неврологический минимум.

## 6. Анамнез

Жалоба и точное время начала · препараты, введённые до приезда, включая данные родственниками: название, доза, время · аллергия · хронические заболевания и наблюдение · постоянная терапия с упаковок · вакцинация по возрасту · последний приём пищи и жидкости, мочеиспускание и стул · контакты по инфекции, поездки, детское учреждение.

::: {.opasnye}
**Безнадзорный ребёнок.** Полный осмотр кожи с описанием каждого кровоподтёка: локализация, размер, цвет, форма. Кровоподтёки на закрытых участках, на разных стадиях заживления и с отпечатком предмета — маркеры физического насилия. Температура, глюкоза и SpO₂ измеряются полностью независимо от внешнего впечатления: карта вызова может оказаться единственным медицинским документом на этого ребёнка за сутки. Отдельно — хронические заболевания без лечения: эпилепсия без противосудорожных, диабет без инсулина, психиатрический диагноз без поддерживающей терапии.
:::
