...
| № | Вывод |
|---|---|
| 1 | Обморок на нагрузке или при плавании и QTc 490 мс — синдром удлинённого QT, тип 1, а не переутомление. Госпитализация, препараты на месте не нужны. |
| 2 | Нормальный QT при обмороке на эмоции или нагрузке — CPVT. Адреналин и амиодарон не используют; первая линия — β-адреноблокатор и магний. |
...
| 10 | Курчавые волосы, кератодерма ладоней и желудочковая эктопия — синдром Карвахаля. Интенсивный спорт запрещён. |
