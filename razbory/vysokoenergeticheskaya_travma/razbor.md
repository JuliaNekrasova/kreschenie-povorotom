<div class="titlepage">
  ...
  <div class="source src-last">Серия «Крещение поворотом» · версия 1.2 · 19 августа 2026 · CC BY-NC-SA 4.0</div>
</div>
...
Canadian CT Head Rule (Stiell et al., 2001) — валидированный набор критериев, отвечающий на один вопрос: кому из пациентов с лёгкой черепно-мозговой травмой нужна компьютерная томография головы. Правило создавалось для приёмных отделений, чтобы сократить число избыточных исследований, и его практическая ценность для линии в другом: оно перечисляет обстоятельства, при которых травма головы не может считаться пустяком, даже если пациент выглядит целым.

Область применения — пациенты 16 лет и старше с ШКГ 13–15, у которых была утрата сознания, амнезия события или дезориентация. Правило не применяется при ШКГ ниже 13, у детей, при приёме антикоагулянтов и нарушениях свёртывания, при судороге после травмы и при очаговом неврологическом дефиците: все эти пациенты идут на томографию вне правила.

| Группа критериев | Критерий | Что предсказывает |
|---|---|---|
| Высокий риск | ШКГ ниже 15 через 2 часа после травмы | Потребность в нейрохирургическом вмешательстве |
| Высокий риск | Подозрение на открытый или вдавленный перелом черепа | То же |
| Высокий риск | Любой признак перелома основания черепа: гемотимпанум, периорбитальные гематомы, заушная гематома, ликворея из носа или уха | То же |
| Высокий риск | Два и более эпизода рвоты | То же |
| Высокий риск | Возраст 65 лет и старше | То же |
| Средний риск | Ретроградная амнезия 30 минут и более (не помнит события до травмы) | Клинически значимая находка на томограмме |
| Средний риск | Опасный механизм: наезд на пешехода, выброс из автомобиля, падение с высоты более 0,9 м или более пяти ступеней | То же |

Наличия любого одного критерия достаточно для показания к томографии. Обратная сторона правила существеннее прямой: пациент с ШКГ 15, без рвоты и без признаков перелома, но с опасным механизмом или ретроградной амнезией всё равно попадает в группу, требующую снимка. Именно поэтому фраза «сознание ясное, жалоб нет» не закрывает вопрос о травме головы при высокоэнергетическом механизме.

**Расхождение с российской практикой отмечается явно.** Приказ ДЗМ № 535 объединяет черепно-мозговую травму в один алгоритм (внутренняя стр. 73 для взрослых, стр. 212 для детей) и критериями отбора на томографию не оперирует: объём догоспитальной помощи определяется клиникой и уровнем сознания, а решение о визуализации принимается в стационаре, куда пациент с травмой головы доставляется. Для догоспитального этапа канадское правило — не инструмент отбора и тем более не основание оставить пациента дома, а перечень обстоятельств, которые обязательно передаются в приёмное отделение: механизм, факт и длительность амнезии, число эпизодов рвоты, динамика ШКГ по времени. У детей правило не работает — там применяются педиатрические критерии (PECARN).
...
<figure class="kvadrat">
  <img src="images/perelomovyvih_c3_c4_mrt.png" alt="Переломовывих C3-4 на магнитно-резонансной томограмме, сагиттальная проекция">
  <figcaption>Переломовывих C3–C4, магнитно-резонансная томография, сагиттальная проекция. Видно смещение на уровне C3/C4 с нарушением задней линии тел позвонков и отёк окружающих тканей; в исходном описании случая — двусторонний замок фасеточных суставов, то есть повреждены все три колонны. Случай иллюстрирует и многоуровневость: у пострадавшей после падения с высоты около шести метров одновременно обнаружены перелом задней дуги C1, перелом C2 палаческого типа, этот переломовывих C3/C4, разрыв жёлтой связки на уровне C7–Th1, компрессионные переломы верхних замыкательных пластинок нескольких грудных позвонков и сгибательно-дистракционный перелом Th12 типа Chance — шесть уровней в одном пострадавшем. Снимок из другого клинического наблюдения. Case courtesy of Frank Gaillard, Radiopaedia.org, rID: 5525, CC BY-NC-SA 3.0.</figcaption>
</figure>
...
Классы кровопотери по ATLS удобно держать через шоковый индекс (ЧСС / систолическое АД): до 0,7 — норма; около единицы — потеря 15–30 %; выше единицы — более 30 %, класс III с падением систолического давления. Ограничения индекса: бета-адреноблокаторы и кардиостимулятор фиксируют частоту; у молодых компенсация держит давление до последнего, и первым признаком часто оказывается не гипотензия, а сужение пульсового давления и тревожность.
...
Отсюда принципы damage control resuscitation: пермиссивная гипотензия (целевое систолическое 80–90 мм рт. ст. — выше тромбы срывает), ограничение кристаллоидов (до литра; каждый следующий литр разводит факторы свёртывания и охлаждает), транексамовая кислота в первые три часа (CRASH-2: снижение смертности от кровотечения при раннем введении и вред при позднем; по Приказу 535 — 1000 мг внутривенно за 10 минут), тёплые растворы и укрывание, ранняя эвакуация к крови и операционной. Исключение из пермиссивной гипотензии — тяжёлая черепно-мозговая травма: при ШКГ ≤ 8 целевое систолическое давление выше 100 мм рт. ст., потому что гипотензия при тяжёлой ЧМТ удваивает летальность; конфликт целей решается вазопрессором и остановкой кровотечения, а не литрами кристаллоидов.
...
- Gaillard F. Spinal fracture dislocation C3-4. Case study, Radiopaedia.org, публикация 30.01.2009, <https://doi.org/10.53347/rID-5525> — источник магнитно-резонансного снимка переломовывиха и данных о многоуровневом характере повреждений.
...
| `perelomovyvih_c3_c4_mrt.png` | Переломовывих C3–C4, МРТ, сагиттальная проекция | Case courtesy of Frank Gaillard, [Radiopaedia.org](https://radiopaedia.org/), rID: [5525](https://radiopaedia.org/cases/5525). CC BY-NC-SA 3.0 |
...
**Материал:** «Высокоэнергетическая травма». Версия 1.2 от 19 августа 2026. Добавлена томограмма перелома Чанса. В версии 1.1 раскрыто канадское правило компьютерной томографии головы, уточнена анатомия тазового кольца, добавлены иллюстрации переломов позвоночника и раздел о многоуровневых повреждениях.
