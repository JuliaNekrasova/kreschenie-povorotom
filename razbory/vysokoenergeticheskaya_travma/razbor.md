<div class="titlepage">
  ...
  <div class="source src-last">Серия «Крещение поворотом» · версия 1.0 · 18 августа 2026 · CC BY-NC-SA 4.0</div>
</div>
...
2. Сознание ясное, ШКГ 15, речь внятная. Какие данные анамнеза и осмотра тем не менее означают, что черепно-мозговая травма у этого пациента есть, — и что из этого следует для наблюдения в пути?
...
Практическое значение: пациент с сотрясением и ШКГ 15 не нуждается в специфической догоспитальной терапии, но нуждается в двух вещах — в наблюдении за динамикой сознания в пути и в госпитализации с визуализацией. Канадское правило КТ головы относит опасный механизм (пешеход, выброс из автомобиля, падение с высоты) и ретроградную амнезию к показаниям для томографии даже при полных пятнадцати баллах. Смысл наблюдения — эпидуральная гематома со светлым промежутком: классическое течение включает возвращение полного сознания между моментом травмы и повторным угнетением, и пациент, «загрузившийся» через сорок минут после аварии, — это повод пересчитать ШКГ по компонентам, а не списать на усталость.
...
## Кольцо и его содержимое

Таз — замкнутое кольцо из двух безымянных костей и крестца, соединённых лонным сочленением спереди и крестцово-подвздошными суставами сзади. Кольцевая геометрия диктует правило: кольцо не ломается в одной точке — перелом или разрыв связок спереди означает повреждение и сзади, видимое или нет.
...
**2.** Амнезия самого момента аварии (эквивалент эпизода нарушенного сознания — человек, терявший сознание, этот промежуток не помнит), головокружение и тошнота (вегетативно-вестибулярный блок), гематома лба (точка приложения силы), горизонтальный нистагм. Совокупность — сотрясение головного мозга при полных пятнадцати баллах. Следствия: ШКГ фиксируется по компонентам с временными метками, повторяется в пути; любое угнетение сознания трактуется как мозговое до опровержения; госпитализация с визуализацией обязательна — опасный механизм и амнезия входят в показания к КТ по канадскому правилу даже при ШКГ 15.
...
**Материал:** «Высокоэнергетическая травма». Версия 1.0 от 18 августа 2026.
