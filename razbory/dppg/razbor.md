<div class="titlepage">
  ...
  <div class="rule"></div>
  <div class="source">С разбором клинического наблюдения: молодой мужчина с позиционным головокружением и неустойчивостью, исключённой ортостатической гипотензией, сомнительным нистагмом с латентным периодом около 5 секунд и кратковременным эффектом репозиционного маневра.</div>
  <div class="source src-last">Серия «Крещение поворотом» · версия 1.1 · 8 сентября 2026 · CC BY-NC-SA 4.0</div>
</div>
...
«Это был последний вызов смены. Молодой мужчина, головокружение при вставании, всё кружится вокруг. В позе Ромберга неустойчив, но сидит и стоит, хотя шатает. Давление сидя и стоя ему меряла, одинаково вообще, даже минимальной разницы не заметила. Координаторные пробы — без промахивания. Очаговой симптоматики нет. Делала ему пробу Дикса — Холлпайка, в какой-то момент при наклоне на левую сторону показалось, что глаза как-то странно задергались, мелко так, как бы задрожали. Не сразу, а секунд через 5 как-то странно глаза задергались. Я еще раз повторила пробу, на этот раз значительно резче. Может быть, я ее делала как-то неправильно, слишком резко и с поворотом на бок, что скорее уже похоже на Эппли (ну что могла, то вспомнила в 6 утра после ночи), но пациент сказал, что после второй попытки ему стало легче. Мы его тут же посадили, поставили, но очень быстро при этом головокружение вернулось. Наверное, я просто немного двинула эти отолиты, но недостаточно хорошо, чтобы вылечить окончательно. В любом случае такой симптом скорее за ДППГ.» — *Ю.Н.*
...
1. Жалоба «кружится при вставании» допускает два механизма. Какие это механизмы и каким измерением, с какой методикой и какими порогами, они разделяются?
2. Какие характеристики позиционного нистагма делают пробу Дикса — Холлпайка интерпретируемой и почему торсионный компонент плохо различим без очков Френцеля?
3. По каким признакам позиционный нистагм центрального происхождения отличается от нистагма при каналолитиазе заднего канала?
4. Каковы причины отрицательного результата пробы Дикса — Холлпайка при действительном ДППГ и какая проба выполняется следующей?
5. Почему при ДППГ неприменим комплекс HINTS и при каком синдроме он применяется?
6. Как оценивается результат репозиционного маневра и о чём говорит возврат головокружения сразу после его выполнения?
7. Что предусматривают Алгоритмы при головокружении с рвотой, каково фармакологическое обоснование каждого назначения и в чём состоит расхождение с рекомендациями AAO-HNS 2017?
...
Центральный паттерн (мнемоника INFARCT): **I**mpulse **N**ormal — нормальный результат пробы толчка головой; **F**ast-phase **A**lternating — меняющееся направление быстрой фазы; **R**efixation on **C**over **T**est — вертикальная коррекция при пробе с попеременным прикрытием. Наличие любого из трёх признаков указывает на центральное поражение.
...
Наиболее частая причина повторных эпизодов головокружения у пациентов молодого и среднего возраста. Критерии Барани-общества и ICHD-3 требуют **не менее пяти** эпизодов вестибулярной симптоматики умеренной или выраженной интенсивности длительностью от 5 минут до 72 часов при наличии мигрени в анамнезе и мигренозных признаков (головная боль соответствующего характера, фото- и фонофобия, зрительная аура) не менее чем в половине эпизодов. Возможен позиционный компонент, что создаёт сходство с ДППГ; отличие — большая длительность эпизодов и отсутствие типичного истощаемого торсионного нистагма.
...
**Ортостатическая гипотензия исключена измерением.** Артериальное давление измерено в положении сидя и стоя, различий не выявлено. Этим снимается вторая из двух трактовок жалобы «кружится при вставании», и дифференциальный ряд сокращается до вестибулярных причин. Методическая оговорка касается чувствительности использованного варианта пробы: консенсусное определение ортостатической гипотензии (снижение систолического давления на 20 мм рт. ст. или диастолического на 10 мм рт. ст.) построено на переходе из положения лёжа в вертикальное с измерением на 1-й и 3-й минутах; вариант «сидя — стоя» уступает ему по чувствительности, поскольку часть венозного депонирования уже реализована в положении сидя. Полное отсутствие разницы давления делает ортостатический механизм маловероятным и в этом варианте пробы.

**Координаторные пробы без промахивания и отсутствие очаговой симптоматики.** Сохранная точность пальце-носовой пробы исключает атаксию конечностей, то есть поражение полушарий мозжечка и латеральных отделов продолговатого мозга. Разграничительная сила этого признака ограничена: центральное позиционное головокружение возникает при поражении узелка и язычка мозжечка и структур IV желудочка, где аппендикулярная координация может оставаться интактной. Совокупность признаков — сохранная способность сидеть и стоять, отсутствие дизартрии, диплопии, дисфагии и расстройств чувствительности — смещает вероятность к периферическому поражению, но заменой оценке характеристик самого позиционного нистагма не служит.

**Латентный период около 5 секунд.** Указание «не сразу, а секунд через 5» — единственная документированная характеристика вызванного нистагма, и она диагностически значима. Латентность 1–5 секунд (до 20) соответствует времени начала движения конгломерата отоконий в просвете канала и является признаком каналолитиаза. Она же разграничивает наблюдаемое явление с двумя альтернативами: при купулолитиазе нистагм возникает без латентного периода, при центральном позиционном нистагме латентный период также, как правило, отсутствует.

**Мелкая амплитуда и сторона провокации.** Описание «мелко так, как бы задрожали» соответствует ожидаемой картине: позиционный нистагм заднего канала имеет малую амплитуду и преимущественно торсионный компонент, различимый при обычном освещении хуже горизонтального, а фиксация взора его дополнительно подавляет. Проба с поворотом головы влево исследует левый задний полукружный канал, то есть предполагаемая сторона поражения — левая. Незафиксированными остались направление быстрой фазы (при каналолитиазе заднего канала — торсионный компонент к нижележащему уху в сочетании с вертикальным вверх), длительность (менее 60 секунд) и истощаемость. Без них заключение остаётся вероятностным.

**Повторение пробы «значительно резче».** Недостаточная скорость укладывания входит в перечень причин ложноотрицательного результата пробы Дикса — Холлпайка наряду с недостаточным разгибанием шеи и ремиссией на момент осмотра; методика предусматривает укладывание за 1–2 секунды. Повторение пробы в более быстром темпе технически оправдано. Ограничением служит истощаемость: при повторных пробах интенсивность нистагма закономерно снижается, поэтому вторая попытка менее информативна, чем первая, даже при правильном исполнении.

**Переход диагностической пробы в репозиционный маневр.** Продолжение поворота на бок из положения пробы Дикса — Холлпайка соответствует четвёртому шагу маневра Эпли; переход через положение сидя на противоположный бок соответствует маневру Семона. С момента, когда к пробе добавлен поворот туловища, исследование перестаёт быть диагностическим: при успешном перемещении отоконий последующая проба будет отрицательной независимо от исходного диагноза. Диагностическая и лечебная процедуры в этом случае оказались объединены в одном действии, что закономерно для условий вызова, но лишает результат самостоятельной доказательной ценности.

**Улучшение после второй попытки и возврат головокружения при вертикализации.** Критерием эффективности репозиции служит перевод пробы Дикса — Холлпайка из положительной в отрицательную (отношение шансов 9,62 по данным Кокрейновского обзора), а не самочувствие пациента непосредственно после маневра. Головокружение при переводе в положение сидя составляет пятый шаг маневра Эпли и относится к ожидаемым явлениям. Кроме того, ДППГ по определению воспроизводит приступ при каждом провоцирующем движении головы, поэтому возобновление головокружения при усаживании и вставании само по себе не свидетельствует о неудаче. Интерпретация бригады — неполное перемещение отоконий — входит в число возможных наряду с резидуальным головокружением, сохраняющимся после успешной репозиции у 30–60 % пациентов в течение нескольких суток, и переходом отоконий в другой канал (canal switch, 6–8 %), который распознаётся по смене характера нистагма на горизонтальный. Разграничение требует повторной пробы через несколько минут после маневра.

**Отрицательные результаты целенаправленного опроса.** Собраны четыре позиции, каждая из которых снимает конкретный диагноз, а не просто расширяет описание. Слух не снижен, шума и заложенности в ухе нет: этим исключаются лабиринтит и болезнь Меньера, диагностические критерии которой требуют документированного снижения слуха на низких и средних частотах и флуктуирующих ушных симптомов на поражённой стороне; сохранный слух снижает и вероятность инфаркта в бассейне передней нижней мозжечковой артерии. Головной и шейной боли нет: боль в шее и затылке относится к наиболее частым и нередко первым проявлениям диссекции позвоночной артерии, и её отсутствие уменьшает вероятность этого диагноза, хотя полностью его не снимает. Эпизод первый: критерии болезни Меньера требуют не менее двух спонтанных эпизодов, критерии вестибулярной мигрени — не менее пяти, поэтому оба диагноза в качестве определённых не формулируются. Для ДППГ дебют в виде первого эпизода типичен и аргументом против не является.

**Молодой возраст при отсутствии травмы в анамнезе.** Пик заболеваемости ДППГ приходится на 50–70 лет. У молодых пациентов заболевание встречается, но требует уточнения этиологии, и первым из уточняемых вариантов выступает посттравматический каналолитиаз, который в этой возрастной группе составляет существенную долю случаев и чаще бывает двусторонним и многоканальным. Анамнез травмы собран целенаправленно и отрицателен, что этот вариант снимает. Остаются идиопатический каналолитиаз, составляющий 50–70 % всех случаев независимо от возраста, отсроченные последствия длительного вынужденного положения головы (стоматологические вмешательства, операции, постельный режим), вестибулярная мигрень и дебют иных вестибулярных расстройств. Отсутствие травмы не влияет на относительную значимость центральных причин, сохраняющуюся повышенной в молодом возрасте: рассеянный склероз, диссекция позвоночной артерии.

**Данные, оставшиеся несобранными.** Их четыре. Длительность отдельного приступа при удержании провоцирующего положения не засечена — это признак, отделяющий ДППГ (менее 60 секунд) от состояний с более продолжительным головокружением, и в отсутствие документированного направления нистагма он остаётся наиболее весомым из недостающих. Анамнез длительного вынужденного положения головы (стоматологические вмешательства, операции, постельный режим) и мигренозный анамнез не уточнялись: первый указывал бы на этиологию каналолитиаза, второй — на вестибулярную мигрень как альтернативу. Повторная проба Дикса — Холлпайка после маневра не выполнялась, поэтому результат вмешательства не оценён по принятому критерию. Supine roll test не выполнялся, что оставляет неисключёнными поражение горизонтального канала и переход отоконий в него после маневра.

**Дифференциальный ряд с учётом полученных данных.**

| Состояние | Данные за | Данные против / не оценено |
|---|---|---|
| ДППГ заднего канала слева | системное головокружение; провокация изменением положения головы; позиционный нистагм с латентным периодом около 5 секунд при укладывании влево; временное улучшение после маневра с элементами репозиции | направление быстрой фазы, длительность и истощаемость не документированы; нехарактерный возраст при отрицательном травматическом анамнезе; результат маневра повторной пробой не подтверждён |
| Ортостатическая гипотензия | провокация вставанием | **исключена:** давление сидя и стоя без различий; системный характер головокружения нетипичен |
| Вестибулярный нейронит | системное головокружение, неустойчивость | нейронит протекает как однократный непрерывный эпизод длительностью в сутки, а не как приступы при перемене положения; спонтанный нистагм не описан |
| Центральное позиционное головокружение | молодой возраст; неустойчивость в позе Ромберга | латентный период присутствует; сохранена способность сидеть и стоять; координаторные пробы без промахивания; очаговая симптоматика, головная и шейная боль отсутствуют |
| Болезнь Меньера | системное головокружение | слух не снижен, шума и заложенности нет; эпизод первый (критерий требует не менее двух); приступы при ней спонтанные, а не позиционные |
| Вестибулярная мигрень | молодой возраст | эпизод первый (критерий требует не менее пяти); мигренозный анамнез не уточнён; длительность эпизодов не уточнена |
| Диссекция позвоночной артерии | молодой возраст | головная и шейная боль отсутствуют; очаговая симптоматика отсутствует; координаторные пробы без промахивания |

**Заключение бригады.** Формулировка «такой симптом скорее за ДППГ» соответствует полученным данным: провокация изменением положения головы, латентный период около 5 секунд, исключённая измерением ортостатическая гипотензия, отрицательный травматический анамнез, сохранный слух, отсутствие головной и шейной боли, отсутствие очаговой симптоматики и признаков центрального позиционного нистагма. Ни один альтернативный диагноз дифференциального ряда не подкреплён положительными находками. Диагностический вес заключения остаётся вероятностным по одной причине — недокументированным направлению и длительности нистагма. Запись в карте вызова, отражающая это состояние данных, содержит описание наблюдавшегося (латентный период, сторона укладывания, воспроизведение типичного головокружения) и отдельное указание на то, что направление и длительность нистагма достоверно не оценены; заключение «проба положительна» без этих характеристик не позволяет ни подтвердить диагноз, ни отличить периферический позиционный нистагм от центрального.

**Тактика, следующая из картины.** Красные флаги отсутствуют, рвоты нет, следовательно медикаментозные назначения раздела Алгоритмов не применяются, а вестибулярные супрессанты не показаны и подавляют признак, на котором строится дальнейшая диагностика. Соответствующий картине объём — актив в поликлинику с указанием на необходимость выполнения репозиционного маневра оториноларингологом или неврологом и на предполагаемую сторону поражения.

# Ответы на вопросы для размышления

**1.** Позиционный и ортостатический. При ДППГ триггером служит изменение положения головы относительно вектора силы тяжести (укладывание, поворот в постели, запрокидывание головы, наклон вперёд); вставание входит в этот ряд постольку, поскольку сопровождается изменением положения головы. При ортостатической гипотензии триггером является собственно переход в вертикальное положение. Разделяются измерением артериального давления лёжа и через 1 и 3 минуты после вставания; диагностический порог — снижение систолического давления на 20 мм рт. ст. или диастолического на 10 мм рт. ст. Вариант «сидя — стоя» уступает по чувствительности, поскольку часть венозного депонирования реализуется уже в положении сидя.

**2.** Четыре характеристики: латентный период 1–5 секунд (до 20); торсионно-вертикальное направление — быстрая фаза к нижележащему уху в сочетании с движением вверх, к лбу; длительность менее 60 секунд с динамикой нарастания и убывания; истощаемость при повторных пробах. Дополнительно оценивается реверсия направления при возвращении в положение сидя. Торсионный компонент различим хуже горизонтального при обычном освещении, а фиксация взора подавляет периферический нистагм; очки Френцеля и видеонистагмография устраняют фиксацию и повышают чувствительность метода.

**3.** Против ДППГ и за центральное поражение свидетельствуют: отсутствие латентного периода; отсутствие истощаемости при повторении; длительность более 60 секунд при сохранении положения; чисто вертикальный нистагм, направленный вниз (downbeat); направление нистагма, не соответствующее плоскости ни одного из каналов; несоответствие между выраженным нистагмом и слабым субъективным головокружением; сопутствующая очаговая симптоматика (дизартрия, диплопия, дисфагия, атаксия конечностей, расстройства чувствительности); невозможность самостоятельно сидеть или стоять.

**4.** Чувствительность пробы составляет 79–82 % при специфичности 71–75 % (Halker et al., 2008). Ложноотрицательный результат возможен при ремиссии на момент осмотра, недостаточной скорости укладывания (методика предусматривает 1–2 секунды), недостаточном разгибании шеи (требуется 20–30° ниже горизонтали), а также при поражении горизонтального канала, которое данной пробой не выявляется. При отрицательном результате и клинической картине, соответствующей ДППГ, выполняется supine roll test (проба Пагнини — Мак-Клюра).

**5.** HINTS предназначен для разграничения периферического и центрального поражения при остром продолжающемся вестибулярном синдроме — непрерывном головокружении со спонтанным нистагмом на момент осмотра. ДППГ протекает как кратковременные приступы без спонтанного нистагма в межприступном периоде, поэтому проба толчка головой, оценка нистагма и тест с попеременным прикрытием при нём не интерпретируются. Центральный паттерн HINTS обозначается мнемоникой INFARCT: нормальный результат пробы толчка головой, меняющееся направление быстрой фазы, вертикальная коррекция при пробе с попеременным прикрытием.

**6.** Критерий эффективности — перевод пробы Дикса — Холлпайка из положительной в отрицательную при повторном выполнении (отношение шансов 9,62; 95 % ДИ 6,0–15,42), а не субъективное улучшение сразу после маневра. Возврат головокружения при усаживании и вставании самостоятельного значения не имеет: воспроизведение головокружения на завершающем шаге маневра Эпли закономерно, а ДППГ по механизму даёт новый приступ при каждом провоцирующем движении головы. Возможные объяснения раннего возврата: неполное перемещение отоконий, резидуальное головокружение (30–60 % пациентов в течение нескольких суток после успешной репозиции), переход отоконий в горизонтальный канал (canal switch, 6–8 %), состояние иной природы. Постпроцедурные ограничения положения тела исхода не улучшают: AAO-HNS 2017 даёт строгую рекомендацию против них.

**7.** Раздел «Болезни внутреннего уха» Алгоритмов квалифицирует вестибулярную патологию как не требующую лечения на этапе оказания неотложной помощи; при головокружении с рвотой предусмотрены ЭКГ, глюкометрия, магния сульфат 2500 мг (10 мл) внутривенно медленно, метоклопрамид 5–10 мг (1–2 мл) внутривенно, атропин 1 мг (1 мл) внутримышечно или подкожно. Метоклопрамид обоснован как противорвотное, с оговоркой о риске экстрапирамидных реакций (около 1 %, выше у пациентов моложе 30 лет). Магния сульфат фармакологического обоснования при вестибулярном головокружении не имеет. Атропин имеет два обоснования: вестибулярная супрессия через мускариновые рецепторы вестибулярных ядер (доказательная база класса построена на скополамине и относится к профилактике укачивания) и устранение вагусной брадикардии при вестибуло-вегетативной реакции — последнее состоятельнее. Ни один из препаратов не воздействует на механизм ДППГ, а подавление нистагма лишает стационар интерпретируемой глазодвигательной картины. AAO-HNS 2017 определяет содержание помощи как диагностику пробой Дикса — Холлпайка и лечение репозиционным маневром или направление к специалисту, способному его выполнить (обе рекомендации строгие), с рекомендацией против рутинных вестибулярных супрессантов и против визуализации при типичной картине. Расхождение касается не оценки эффективности маневров, а распределения компетенций: маневр отнесён к амбулаторному и специализированному звену.
...
**Материал:** «Доброкачественное пароксизмальное позиционное головокружение». Версия 1.1 от 8 сентября 2026. Клиническое наблюдение изложено в расширенной редакции: добавлены результаты ортостатической пробы, координаторных проб, латентный период нистагма и сторона провокации, а также результаты целенаправленного опроса (травма, слух и шум в ухе, головная и шейная боль, повторность эпизодов). В раздел о вестибулярной мигрени внесён критерий повторности эпизодов по Барани-обществу и ICHD-3. Разбор наблюдения перенесён из начала материала в раздел «Возвращение к клиническому случаю» после теоретической части; добавлены вопросы для размышления и ответы на них. Исправлена формулировка признака Fast-phase Alternating в мнемонике INFARCT.
