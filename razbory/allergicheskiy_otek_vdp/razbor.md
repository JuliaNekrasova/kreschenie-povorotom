...
<p>С точки зрения безопасности существен остаток: в шприце сохраняется 9,5 мл раствора, то есть <strong>950 мкг эпинефрина</strong> — практически полная ампула в разведённом виде. Шприц с разведённым раствором подлежит маркировке с указанием концентрации.</p>
</div>
...
| Отсутствие маркировки шприца с разведением | Концентрация раствора неизвестна лицу, использующему шприц следующим |
...
**Повторная внутримышечная доза.** Алгоритмы предусматривают между первым внутримышечным введением и переходом к внутривенному ещё один шаг: при сохранении признаков обструкции через 5 минут от предыдущего введения — повторно эпинефрин 0,01 мг/кг внутримышечно. В карте зафиксированы два наблюдения «без изменений», после которых введён внутривенный эпинефрин; вторая внутримышечная доза не документирована. Установить по карте, была ли доза введена без документирования либо шаг был пропущен, невозможно. Это единственный пункт расхождения записи с предписанным объёмом, и он относится к полноте документирования в большей степени, чем к существу оказанной помощи: эпинефрин введён немедленно и повторно, интервал соблюдён, эскалация выполнена по предусмотренному признаку — сохранению обструкции.
...
**5.** 1 мг в 1 мл плюс 9 мл растворителя дают 10 мл, содержащих 1000 мкг, то есть 100 мкг/мл. Введено 0,5 мл — значит **50 мкг**, или 0,05 мг. В шприце остаётся 9,5 мл, то есть **950 мкг**; шприц подлежит маркировке с указанием концентрации. Разведение предписано Алгоритмами: при сохранении признаков обструкции верхних дыхательных путей — эпинефрин 1 мг (1 мл) в разведении натрия хлорида 0,9 % 9 мл, от полученного раствора ввести 0,5 мл внутривенно.
