...
Инверсия зубца T в II, III, aVF сразу после остановки тахикардии — это может быть либо **постконверсионная Т-память** (cardiac memory), либо **транзиторная ишемия**, связанная с высокой частотой. Объяснить изменения однозначно, без тропонинов и полной динамики, невозможно.
...
- Без тропонина и дальнейшей динамики нельзя исключить ишемическую компоненту.
