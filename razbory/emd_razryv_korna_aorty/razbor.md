...
Классификация строится по двум основаниям: анатомическому — вовлечена ли восходящая аорта, и временно́му — сколько времени прошло от появления симптомов.

**Анатомическая классификация Стэнфорда** различает два типа. К типу A относят расслоение с вовлечением восходящей аорты независимо от места входного повреждения интимы и от протяжённости дистального распространения. К типу B — расслоение, при котором восходящая аорта не вовлечена, а поражение располагается дистальнее левой подключичной артерии. Тип A составил 62,3 % из 464 наблюдений первой публикации IRAD (Hagan, JAMA, 2000); по сводным данным EACTS и STS 2024 года на тип A приходится 59–67 % острых аортальных синдромов, на тип B — около 31 %.

**Классификация Дебейки** учитывает и место входного повреждения, и протяжённость: тип I — входное повреждение в восходящей аорте с распространением на дугу и ниже; тип II — поражение ограничено восходящей аортой; тип III — входное повреждение дистальнее левой подключичной артерии, с распространением до диафрагмы (IIIa) или ниже неё (IIIb). Типы I и II Дебейки соответствуют типу A Стэнфорда, тип III — типу B.

<figure>
  <img src="images/klassifikaciya_debakey_stanford.png" alt="Схема: классификация расслоений аорты по Дебейки и по Стэнфорду">
  <figcaption>Анатомические классификации расслоения аорты. Тёмным показан ложный канал. Дебейки I — входное повреждение в восходящей аорте, расслоение распространяется на дугу и нисходящую аорту; Дебейки II — поражение ограничено восходящей аортой; Дебейки III — входное повреждение дистальнее левой подключичной артерии с распространением книзу. Скобки внизу показывают соответствие классификации Стэнфорда: типы I и II объединены в тип A, поскольку оба требуют экстренной операции, тип III соответствует типу B.</figcaption>
</figure>

Отдельно выделяют расслоение, захватывающее дугу аорты без вовлечения восходящей: в классификацию Стэнфорда оно не укладывается и обозначается как non-A non-B. На него приходится 3–10 % наблюдений (EACTS и STS, 2024).

**Временна́я классификация:** острое расслоение — до 14 суток от появления симптомов, подострое — 15–90 суток, хроническое — 91 сутки и более.

| Признак | Тип A | Тип B |
|---|---|---|
| Определение | Вовлечена восходящая аорта | Восходящая аорта не вовлечена, поражение дистальнее левой подключичной артерии |
| Доля | 59–67 % | около 31 % |
| Основное лечение | Экстренная операция почти во всех случаях | При неосложнённом течении — медикаментозное; при осложнённом — эндоваскулярное протезирование |
| Госпитальная летальность (IRAD, 2000) | 26 % при операции, 58 % без операции | 10,7 % при медикаментозном лечении, 31,4 % при операции |
| Характерные осложнения | Тампонада сердца, острая аортальная регургитация, вовлечение устий коронарных артерий, инсульт | Мальперфузия внутренних органов и конечностей, разрыв в плевральную полость |

Разграничение типов требует визуализации и на догоспитальном этапе недоступно. Значение этого разграничения для бригады иное: тип A составляет большинство острых расслоений, лечится хирургически и определяет маршрут — стационар с кардиохирургической службой.

Применительно к настоящему наблюдению: обнаружение крови в полости перикарда указывает на вовлечение внутриперикардиального отдела аорты, то есть соответствует типу A.
...
грудной аорты; в полости перикарда обнаружена кровь. Наличие крови в полости перикарда указывает на вовлечение
внутриперикардиального отдела аорты, то есть соответствует типу A по Стэнфорду.
...
- Czerny M., Grabenwöger M., Berger T. et al. EACTS/STS Guidelines for diagnosing and treating acute and chronic syndromes of the aortic organ. *European Journal of Cardio-Thoracic Surgery*, 2024 — доли типов A, B и non-A non-B, временна́я классификация расслоений.
...
|---|---|---|
| `klassifikaciya_debakey_stanford.png` | Схема: классификация расслоений аорты по Дебейки (I, II, III) и по Стэнфорду (A, B) | Vanda Machová, MD, Wikimedia Commons, CC BY 3.0 |
