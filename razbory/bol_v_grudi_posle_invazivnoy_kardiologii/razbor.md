...
Девять вопросов до разбора. Отвечать письменно не нужно, достаточно сформулировать ответ про себя и заметить те места, где его нет: дальше по тексту они попадут в готовое пустое гнездо, а не в общий поток. Ответы — в конце материала, сверяться с ними имеет смысл после прочтения, а не сразу.
...
9. ЭКГ на вторые сутки после аблации не отличается от плёнки, выданной при выписке. Насколько это снимает подозрение на перикардит?
...
**9.** Почти не снимает. Изменения ЭКГ при клинически диагностированном постаблационном перикардите выявляются у 19,5–60 % пациентов, то есть у большинства плёнка нормальная или неотличима от прежней. Нормальная ЭКГ работает против коронарного события, а не против перикардита: диагноз перикардита клинический, по характеру боли и её зависимости от положения тела и дыхания.
