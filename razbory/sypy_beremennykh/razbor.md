...
Акушерской патологии вроде нет, в инфекционном плане не уверен, но подъём температуры зафиксирован, поэтому ехать ей в инфекционку.
...
- **Striae gravidarum** (растяжки) — типичны для III триместра, локализуются на животе, бёдрах, груди
...
|---|---|---|---|---|---|
| **PUPPP (полиморфная сыпь беременных)** | III триместр, чаще primigravida | Живот, особенно в области растяжек | Уртикарии, папулы, бляшки | Есть | Благоприятный, проходит после родов |
...
| **Внутрипечёночный холестаз** | III триместр | Нет сыпи или слабо выраженные экскориации | Обычно нет сыпи | Сильный зуд | Риск для плода, требует лечения |
| **Псориаз** | Любой триместр (может обостряться) | Локти, колени, волосистая часть головы, поясница | Эритематозные бляшки с чешуйками | Может быть | Обычно благоприятный, тяжёлые формы — риск для плода |
| **Атопическая сыпь беременных** | Любой триместр | Любая локализация | Экземоподобная сыпь | Есть | Благоприятный |
...
- **Срок возникновения:** III триместр, преимущественно у primigravida (первая беременность); возможно начало в раннем послеродовом периоде
...
- **Прогноз:** благоприятный; спонтанное разрешение в течение 1–2 недель после родов; рецидивы при последующих беременностях редки
...
**Дифференциальная диагностика:** отличие от крапивницы — постоянная локализация на животе, длительное существование элементов, ассоциация с беременностью. Отличие от пемфигоида беременных — отсутствие пузырей, начало в III триместре, благоприятный прогноз.
...
<figure>
  ...
  <figcaption>Пемфигоид беременных: пузыри и везикулы на эритематозном фоне; характерная локализация вокруг пупка.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Пемфигоид беременных: распространённая сыпь с пузырями на животе и конечностях; характерное начало вокруг пупка.</figcaption>
</figure>

## Внутрипечёночный холестаз беременных

Состояние, не являющееся дерматозом в строгом смысле, но имеющее важное значение в дифференциальной диагностике зуда при беременности.
...
**Дифференциальная диагностика:** отличие от PUPPP — отсутствие связи с растяжками, наличие чешуек, классические локализации (локти, колени). Отличие от пемфигоида беременных — отсутствие пузырей, хроническое течение до беременности.
...
<figure>
  <img src="images/rubella1.jpg" alt="Краснуха">
  <figcaption>Краснуха: пятнисто-папулёзная сыпь на лице и туловище. Изображение: DermNet (CC BY-NC-ND 3.0 NZ).</figcaption>
</figure>
...
<figure>
  <img src="images/varicella123.jpg" alt="Ветряная оспа">
  <figcaption>Ветряная оспа: везикулёзная сыпь на разных стадиях развития; характерная «пёстрая» картина. Изображение: DermNet (CC BY-NC-ND 3.0 NZ).</figcaption>
</figure>
...
- **Риск для матери и плода:** у матери — осложнения дыхательных путей; для плода — риск преждевременных родов
...
1. **Первый вопрос:** когда появилась сыпь, как прогрессировала, что предшествовало появлению
...
|---|---|---|
| **Лихорадка** | Редко, если есть — обычно субфебрильная | Характерна, нередко высокая |
...
4. **Подозрении на пемфигоид беременных** — пузыри, быстрое распространение
...
**Характер сыпи.** Пятна и папулы, местами сливающиеся в бляшки — типичная картина PUPPP. Нет пузырей, что исключает пемфигоид беременных. Нет везикул, что исключает ветряную оспу. Элементы не возвышаются, как при крапивнице, и длительность их существования — несколько дней, а не часы.
...
**Срок беременности.** 33 недели — это III триместр, когда PUPPP возникает наиболее часто. Для пемфигоида беременных более характерно начало во II триместре. Для внутрипечёночного холестаза — III триместр, но обычно нет видимой сыпи, а есть сильный зуд и желтуха.
...
**2.** Сыпь на животе у беременной требует исключения специфических дерматозов беременности (PUPPP, пемфигоид беременных) и инфекционных сыпей (краснуха, ветряная оспа). В первую очередь нужно исключить инфекцию из-за риска для плода.

**3.** PUPPP — самый частый специфический дерматоз беременности, возникает в III триместре, чаще при первой беременности, локализуется на животе в области растяжек, проявляется уртикариями и папулами, зудит, имеет благоприятный прогноз, проходит после родов.

**4.** Пемфигоид беременных — редкий аутоиммунный дерматоз, возникает во II–III триместрах, начинается вокруг пупка, характеризуется пузырями и везикулами, несёт риск для плода (преждевременные роды, гипотрофия), требует системных кортикостероидов и наблюдения.

**5.** Псориаз при беременности может улучшаться у 40–60 % женщин, обостряться у 10–20 %. Характеризуется эритематозными бляшками с серебристыми чешуйками на классических локализациях (локти, колени, волосистая часть головы, поясница). Отличается от PUPPP отсутствием связи с растяжками и наличием чешуек, от пемфигоида беременных — отсутствием пузырей и хроническим течением до беременности.
...
**8.** При отказе от госпитализации необходимо оценить состояние матери и плода, исключить инфекцию, обеспечить возможность наблюдения. Обязательная госпитализация — при признаках инфекции, тяжёлом состоянии, подозрении на пемфигоид беременных или холестаз.
...
<tr><td>2</td><td>PUPPP — III триместр, растяжки, уртикарии, зуд, благоприятный прогноз. Пемфигоид беременных — пузыри, риск для плода, требует кортикостероидов.</td></tr>
