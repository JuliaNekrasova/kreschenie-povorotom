...
Совокупность признаков — локализация на животе в области растяжек, зуд, отсутствие системных признаков инфекции, срок беременности — указывает на PUPPP. Инфекционная природа маловероятна, но требует исключения из-за риска для плода.
