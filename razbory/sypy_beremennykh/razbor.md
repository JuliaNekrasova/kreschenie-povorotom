...
- **Морфология элементов:** уртикарии, папулы, бляшки, возможны единичные везикулы; элементы склонны к слиянию, что может создавать картину, сходную с крапивницей
...
- **Зуд:** вариабель — от отсутствия до выраженного
