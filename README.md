...
<tr><td><strong>Ноотропы и нейропротекция</strong></td><td>Тысяча препаратов, ни одного доказательства: пирацетам, церебролизин, мексидол, семакс, цитофлавин, фенибут — Кокрейн, FDA, AHA, кладбище нейропротекции</td><td>1.0 · 31.08.2026</td><td><a href="farmakologiya/nootropy/nootropy.pdf">PDF, A4, 12 стр.</a></td></tr>
</tbody>
</table>
