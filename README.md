...
- [Клинические разборы](#клинические-разборы) — материалы с кейсом, теорией и разбором, PDF формата A4
- [Тренажёры](#тренажёры) — КОНТУР (транспортная ИВЛ) и ТИТР (шприцевой дозатор)
- [О проекте](#о-проекте) — зачем всё это и как устроены материалы
- [Журнал изменений](CHANGELOG.md) — что и когда исправлено, с указанием версии
- [Оговорка](DISCLAIMER.md) · [Нашли ошибку](#нашли-ошибку) · [Лицензии](#лицензии)

## Клинические разборы

| Материал | Версия | Файл |
|---|---|---|
| Боль в груди после инвазивного вмешательства на сердце | 1.2 · 16.08.2026 | [PDF, A4](razbory/bol_v_grudi_posle_invazivnoy_kardiologii/bol_v_grudi_posle_invazivnoy_kardiologii.pdf) |
