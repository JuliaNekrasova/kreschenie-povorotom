...
| [ЭКГ](#экг) | Разбор реальных плёнок с вызова: одна запись, вопросы, чтение, возвращение к случаю. PDF формата A4 |
...
| Материал | О чём | Версия | Файл |
|---|---|---|---|
| **Проксимальная окклюзия ПМЖВ** | Волна Пардэ, aVR против V1, wrap-around LAD и то, что не является инфарктом правого желудочка | 1.0 · 16.08.2026 | [PDF, A4, 7 стр.](ekg/proksimalnaya_pmzhv/proksimalnaya_pmzhv.pdf) |
| **Трепетание и аллапинин** | Регулярный широкий комплекс, класс IC, риск проведения 1:1, блокада левой ножки | 1.0 · 16.08.2026 | [PDF, A4, 5 стр.](ekg/trepetanie_allapinin/trepetanie_allapinin.pdf) |
