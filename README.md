...
|---|---|
| [Клинические разборы](#клинические-разборы) | Разбор реального вызова: кейс → вопросы перед чтением → теория → возвращение к случаю. PDF формата A4 |
...
| [Журнал изменений](CHANGELOG.md) | Что и когда исправлено, с номером версии |
| [Оговорка](DISCLAIMER.md) · [Если нашли ошибку](#если-нашли-ошибку) · [Лицензии](#лицензии) | Служебное |
